...
VDP_PATTERN_INIT_HI:    .res 2
VDP_TMP_VRAM = $F0


.macro vdp_write_vram data
    lda #<(data)
    sta VDP_REG
    lda #(VDP_WRITE_VRAM_BIT | >data)
    sta VDP_REG
.endmacro

.macro vdp_write_vram_ptr
    lda VDP_TMP_VRAM
    sta VDP_REG
    lda VDP_TMP_VRAM + 1
...
vdp_reset:
    ...
    ; write something to the top left of the screen.
    vdp_write_vram $28
    jsr print
...
ascii_set_loop:
    ...
    inc
    cmp #$80 
    bne ascii_set_loop ; will be true after $FF
    rts
...
vdp_register_7: .byte $E1       ; FG/BG. 1=>Black, E=>Gray
vdp_end_register_inits:

message:
  .asciiz "TMS9918A ( NTSC is really quite poor )"

  .align 8
vdp_patterns:
; line drawing
     byte $00,$00,$00,$FF,$FF,$00,$00,$00 ; lr 0
    .byte $18,$18,$18,$18,$18,$18,$18,$18 ; ud 1 
    .byte $00,$00,$00,$F8,$F8,$18,$18,$18 ; ld 2 
    .byte $00,$00,$00,$1F,$1F,$18,$18,$18 ; rd 3
    .byte $18,$18,$18,$F8,$F8,$00,$00,$00 ; lu 4
    .byte $18,$18,$18,$1F,$1F,$00,$00,$00 ; ur 5
    .byte $18,$18,$18,$FF,$FF,$18,$18,$18 ; lurd 6
; <nonsense for debug>
